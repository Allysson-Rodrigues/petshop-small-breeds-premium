      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-12 mb-20">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4 text-[11px] font-bold uppercase tracking-widest text-neutral-400">
              <li><Link className="hover:text-black transition-colors" to="/sobre">Sobre Nós</Link></li>
              <li><Link className="hover:text-black transition-colors" to="/servicos">Serviços Premium</Link></li>
              <li><Link className="hover:text-black transition-colors" to="/loja">Loja Exclusiva</Link></li>
              <li><Link className="hover:text-black transition-colors" to="/galeria">Galeria de Estilo</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4 text-[11px] font-bold uppercase tracking-widest text-neutral-400">
              <li className="hover:text-black cursor-default transition-colors">Estética Canina</li>
              <li className="hover:text-black cursor-default transition-colors">SPA & Relaxamento</li>
              <li className="hover:text-black cursor-default transition-colors">Check-up VIP</li>
              <li className="hover:text-black cursor-default transition-colors">Acessórios de Luxo</li>
            </ul>
          </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between border-t border-neutral-100 pt-10 gap-8">
          <div className="flex flex-col md:flex-row items-center gap-8 text-[10px] font-bold tracking-[0.3em] text-neutral-400 uppercase">
            <p>© 2025 Petshop Small Breeds. Heritage of Care.</p>
            <span className="hidden md:block w-1 h-1 bg-neutral-200 rounded-full"></span>
            <p>Itaim Bibi, São Paulo</p>
          </div>

          <div className="flex gap-8 items-center">
            <a href="#" className="text-neutral-400 hover:text-black transition-all transform hover:-translate-y-0.5" aria-label="WhatsApp">
