            ...
            <div className="flex justify-between mt-auto">
              {currentItem.id && (
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium text-red-600 hover:bg-red-50 rounded flex items-center gap-1"
                >
                ...
                >
                  ...
                  <td className="px-6 py-4 text-right">
                    ...
                    <button
                      ...
                      className="text-gray-400 hover:text-primary transition-colors p-1 ml-2"
